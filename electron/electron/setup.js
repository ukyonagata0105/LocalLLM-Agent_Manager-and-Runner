...
export async function runSetup(onProgress) {
    ...
    try {
        ...
        try {
            ...
            dialog.showErrorBox('Setup Error', 'npm is not installed. Please install Node.js from https://nodejs.org');
            return false;
        }
        ...
        dialog.showErrorBox('Setup Error', `Failed to install dependencies: ${error instanceof Error ? error.message : 'Unknown error'}`);
        return false;
    }
}
/**
 ...
 */
export async function runSetupWithUI() {
